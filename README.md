...
The Blinky Squares backlog contains many exciting new developments, including:

* **Amazing effects**: Waves, ripples, gradients, flashes.
* **Interactivity**: Ability to click to create effects.
* **Image upload**: Turn an image into blinky squares.
* **Disco mode**: For when you want to party.
* **Quantum mode**: Squares that simultaneously blink and do not blink.
* **Sentience**: In theory consciousness should emerge from a sufficiently complex grid of blinky squares.